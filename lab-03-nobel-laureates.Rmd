...
There are 'r nrow(nobel)' rows and 'r ncol(nobel) columns in the nobel dataset. Each row repersents a nobel winner.
...
```
 There are more people who receive the prize in the USA.
...
```
the graph doesn't support the buzzfeed claim. they said that people who got the prize in the USA, most of them weren't American but that's not what the graph shows.    
...
germany is the most common with 20
